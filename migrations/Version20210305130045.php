 ...
 */
final class Version20210305130045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, lot_id INT NOT NULL, commissaire_id INT DEFAULT NULL, encherisseur_id INT NOT NULL, ordre_achat_id INT DEFAULT NULL, salle_vente_id INT NOT NULL, id_enchere VARCHAR(255) NOT NULL, date_enchere DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', prix_propose DOUBLE PRECISION NOT NULL, est_adjuge TINYINT(1) NOT NULL, INDEX IDX_38D1870FA8CBA5F7 (lot_id), INDEX IDX_38D1870FF7EA9D21 (commissaire_id), INDEX IDX_38D1870F91D60FC6 (encherisseur_id), INDEX IDX_38D1870F5DD2787F (ordre_achat_id), INDEX IDX_38D1870F61864004 (salle_vente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordre_achat (id INT AUTO_INCREMENT NOT NULL, orderer_id INT DEFAULT NULL, lot_id INT NOT NULL, id_ordre_achat VARCHAR(255) NOT NULL, prix_max DOUBLE PRECISION NOT NULL, date_ordre_achat DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_71306AD9DF123119 (orderer_id), INDEX IDX_71306AD9A8CBA5F7 (lot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, id_personne VARCHAR(255) NOT NULL, nom_personne VARCHAR(50) NOT NULL, prenom_personne VARCHAR(50) NOT NULL, date_naissance DATETIME NOT NULL, telephone VARCHAR(45) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, verif_identite TINYINT(1) NOT NULL, role SMALLINT NOT NULL, mode_paiement SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, vendeur_id INT NOT NULL, categorie_id INT DEFAULT NULL, lot_id INT DEFAULT NULL, acheteur_id INT DEFAULT NULL, stockage_id INT DEFAULT NULL, id_produit VARCHAR(255) NOT NULL, nom_produit VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, prix_reserve DOUBLE PRECISION NOT NULL, prix_depart DOUBLE PRECISION DEFAULT NULL, prix_vente DOUBLE PRECISION DEFAULT NULL, est_vendu TINYINT(1) NOT NULL, en_stock TINYINT(1) NOT NULL, nb_invendu SMALLINT NOT NULL, INDEX IDX_29A5EC27858C065E (vendeur_id), INDEX IDX_29A5EC27BCF5E72D (categorie_id), INDEX IDX_29A5EC27A8CBA5F7 (lot_id), INDEX IDX_29A5EC2796A7BB5F (acheteur_id), INDEX IDX_29A5EC27DAA83D7F (stockage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salle_enchere (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, id_salle_enchere VARCHAR(255) NOT NULL, nom_vente VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_15E7EB5E4DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE enchere ADD CONSTRAINT FK_38D1870FF7EA9D21 FOREIGN KEY (commissaire_id) REFERENCES personne (id)');
        $this->addSql('ALTER TABLE enchere ADD CONSTRAINT FK_38D1870F91D60FC6 FOREIGN KEY (encherisseur_id) REFERENCES personne (id)');
        $this->addSql('ALTER TABLE enchere ADD CONSTRAINT FK_38D1870F5DD2787F FOREIGN KEY (ordre_achat_id) REFERENCES ordre_achat (id)');
        $this->addSql('ALTER TABLE enchere ADD CONSTRAINT FK_38D1870F61864004 FOREIGN KEY (salle_vente_id) REFERENCES salle_enchere (id)');
        $this->addSql('ALTER TABLE estimation ADD CONSTRAINT FK_D0527024F347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
        $this->addSql('ALTER TABLE estimation ADD CONSTRAINT FK_D0527024F7EA9D21 FOREIGN KEY (commissaire_id) REFERENCES personne (id)');
        $this->addSql('ALTER TABLE ordre_achat ADD CONSTRAINT FK_71306AD9DF123119 FOREIGN KEY (orderer_id) REFERENCES personne (id)');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27858C065E FOREIGN KEY (vendeur_id) REFERENCES personne (id)');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC2796A7BB5F FOREIGN KEY (acheteur_id) REFERENCES personne (id)');
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC27DAA83D7F FOREIGN KEY (stockage_id) REFERENCES stockage (id)');
        $this->addSql('ALTER TABLE salle_enchere ADD CONSTRAINT FK_15E7EB5E4DE7DC5C FOREIGN KEY (adresse_id) REFERENCES adresse (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE salle_enchere DROP FOREIGN KEY FK_15E7EB5E4DE7DC5C');
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC2796A7BB5F');
        ...
        $this->addSql('DROP TABLE salle_enchere');
